                        ...
                        <tr class="text-gray-700 dark:text-gray-400 hover:bg-gray-200">
                            ...
                            <td class="px-1 py-3">
                                <div class="flex items-center space-x-4 text-sm justify-center">
                                    ...
                                    {{--{{ route('myleads.details', $lead->id_client_lead) }}--}}
                                    {{--<a href="#" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-amber-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                       aria-label="Detalles"
                                       title="Detalles"
                                       data-toggle="modal"
