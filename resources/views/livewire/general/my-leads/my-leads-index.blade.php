        ...
        <div>
            <div class="flex flex-row flex-wrap mb-4 space-y-4 md:flex-row md:items-end md:space-x-4">
                <div>
                    ...
                    <select name="status" id="status" class="form-select block rounded-md shadow-sm mt-1 block" wire:model="byStatusInMyLeads">
                ...
                {{--<div>
                    ...
                    <select name="channels" id="channels" class="form-select block rounded-md shadow-sm mt-1 block" wire:model="byChannelInMyLeads">
                        <option value="0">Sin seleccionar.</option>
            ...
            <div class="mb-4">
                <input type="text" id="start_my_leads" wire:model.lazy="date_start_my_leads" autocomplete="off" placeholder="Fecha Inicio Registro">
                <input type="text" id="end_my_leads" wire:model.lazy="date_end_my_leads" autocomplete="off" placeholder="Fecha Fin Registro">
            </div>
        </div>
